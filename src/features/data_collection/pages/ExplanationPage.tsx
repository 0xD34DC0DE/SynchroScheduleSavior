        ...
        <Grid container item xs={12} sm={10} spacing={1} alignItems="center">
            <Grid container item xs={5} spacing={2}>
                ...
                {steps.map((Step, index) => (
                    <Step key={index} visibility={index > step ? "hidden" : "visible"}/>
                ))}
...
function Step1(props: GridProps) {
    return (
        <Grid item {...props}>
...
function Step2(props: GridProps) {
    return (
        <Grid item {...props}>
            <Typography variant={"h4"} fontWeight={600}>
...
function Step3(props: GridProps) {
    return (
        <Grid item {...props}>
            <Typography variant={"h4"} fontWeight={600}>
